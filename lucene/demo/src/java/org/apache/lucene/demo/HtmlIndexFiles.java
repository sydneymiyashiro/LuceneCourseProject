/*
Project 1: Part 1 (Text Parsing)

- parses the title into "title" field
- parses the title and body text into "contents" field so that it is retrievable by searching "contents"

- also saves date modified and path as how it was done in IndexFiles.java 
...
public class HtmlIndexFiles {
  ...
  static void indexDoc(IndexWriter writer, Path file, long lastModified) throws IOException {
    try {
      ...
      // add title and text body to contents for searching later ("contents" is searched in SearchFiles)
